            ...
            {error ? (
                ...
                <TableContainer component={Paper} style={{ boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px' }}>
                    <Table aria-label="cpp info table" className='py-3'>
                        <TableHead>
                            <TableRow>
                                <TableCell>Particular Name</TableCell>
                                <TableCell>Particular Ammount</TableCell>
                        ...
                        <TableBody>
                            ...
                            <TableRow >
                                ...
                                <TableCell style={{ color: 'red' }} color='error'>Partial Paid</TableCell>
                            </TableRow>
                            ...
                            <TableRow >
                                ...
                                <TableCell>10000</TableCell>
                                <TableCell>-</TableCell>
                                <TableCell style={{ color: 'green' }} color='success'>Full Paid</TableCell>
                            </TableRow>
